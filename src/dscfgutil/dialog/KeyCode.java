// Modified from the original JavaFX code by Sean Pesce

// Original code here: http://hg.openjdk.java.net/openjfx/2.2/master/rt/file/94a346653a76/javafx-ui-common/src/javafx/scene/input/KeyCode.java
...
public enum KeyCode {
    ...
    public static final Map<Integer, String> codeNameMap;
    static {
        ...
        codeNameMap = new HashMap<Integer, String>(KeyCode.values().length);
        for (KeyCode c : KeyCode.values()) {
        	codeNameMap.put(new Integer(c.code), c.name);
        }
    }
    ...
    /**
     * Parses virtual key code (integer value).
     * @param code Integer value of virtual key code
     * @return String 	the name of the key corresponding to the given key code,
     * 					null if code is unknown.
     * 
     */
    public static String getKeyName(int code) {
    	return codeNameMap.get(new Integer(code));
    }
